...
if __name__ == '__main__':
    ...
    ops = [Constants.OPERATION_MIN, Constants.OPERATION_MAX, Constants.OPERATION_COUNT, Constants.OPERATION_LOOKUP, Constants.OPERATION_COMPARISON, Constants.OPERATION_GROUPING]
