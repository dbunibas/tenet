...
class TestFinder(unittest.TestCase):
    ...
    def setUp(self):
        ...
        table4.addRow(
            [Cell("Marta Schifone", headerCandidate), Cell("Center right", headerParty), Cell(21651, headerVotes)])
        table4.addRow(
            [Cell("Daniela Iaconis", headerCandidate), Cell("Center left", headerParty), Cell(15779, headerVotes)])
        ...
        self.operations = [Constants.OPERATION_LOOKUP, Constants.OPERATION_COMPARISON, Constants.OPERATION_FILTER,
                           Constants.OPERATION_MIN, Constants.OPERATION_MAX, Constants.OPERATION_AVG,
    ...
    def test_finder_evidence_table4(self):
        ...
        evidence1.addRow([Cell("Roberto Fico", Header("Candidate")), Cell("Five Star", Header("Party")),
                          Cell(61819, Header("Votes"))])
        evidence1.addRow([Cell("Marta Schifone", Header("Candidate")), Cell("Centre right", Header("Party")),
                          Cell(21651, Header("Votes"))])
        evidence1.addRow([Cell("Daniela Iaconis", Header("Candidate")), Cell("Center left", Header("Party")),
                          Cell(15779, Header("Votes"))])
