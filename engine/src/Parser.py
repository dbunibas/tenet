...
if __name__ == '__main__':
    ...
    fileInput = Constants.CACHE_DIR + "evidences_g5_s300_140323_r_cr_q.json"
    fileOutput = Constants.CACHE_DIR + "output_evidences_g5_s300_140323_r_cr_q.json"
    f = open(fileInput)
    data = json.load(f)
    explored = []
    print("Exploring the data")
    skippedTables = 0
    maxTables = None  ## None for the full file
    ...
    for example in tqdm(data):
        ...
        pgenerated_random, ngenerated_random = exploreTextForStrategy(generated_random, database, title, operations,
                                                                      comparisons)
        ...
        pgenerated_coldrandom, ngenerated_coldrandom = exploreTextForStrategy(generated_coldrandom, database, title,
    ...
    for example in data:
        ...
        # print("** Generated-coldrandom")
        printGeneratedSentences(generated_coldrandom, database, title, statsColdRandom, negStatsColdRandom,
                                print=printSentences)
