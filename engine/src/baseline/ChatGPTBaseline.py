...
def execute():
    ...
    inputsFile = [Constants.CACHE_DIR + "evidences_sel_3500tables_tabfact_query.json",
                  Constants.CACHE_DIR + "generated_infotabs_random_2000tb_5pertb_130423.json"]
    outputsFile = [Constants.CACHE_DIR + "baselineChatGPT_evidences_sel_3500tables_tabfact_query.json",
                   Constants.CACHE_DIR + "baselineChatGPT_generated_infotabs_random_2000tb_5pertb_130423.json"]
