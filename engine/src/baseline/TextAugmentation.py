...
if __name__ == '__main__':
    fileOutput = "/Users/enzoveltri/git/tenet/test/feverous_train_baseline_augmentation.jsonl"
    maxTables = None
    fileOutputFilter = "/Users/enzoveltri/git/tenet/test/feverous_train_baseline_augmentation_" + str(
        maxTables) + ".jsonl"
...
if __name__ == '__main__xxx':
    ...
    # model = gensim.models.Word2Vec.load_word2vec_format('/Users/enzoveltri/git/tenet/word2vec/GoogleNews-vectors-negative300.bin.gz', binary=True)
    model = gensim.models.KeyedVectors.load_word2vec_format(
        '/Users/enzoveltri/git/tenet/word2vec/GoogleNews-vectors-negative300.bin.gz', binary=True)
    ...
    fileName = "/Users/enzoveltri/git/tenet/test/feverous_train.jsonl"
    fileOutput = "/Users/enzoveltri/git/tenet/test/feverous_train_baseline_augmentation.jsonl"
    visitedIds = set()
    writeType = 'w'
